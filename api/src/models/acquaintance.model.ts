...
@model({
  settings: {idInjection: false, postgresql: {schema: 'game', table: 'acquaintance'}}
})
export class Acquaintance extends Entity {
  ...
  @property({
    type: 'number',
    scale: 0,
    postgresql: {columnName: 'id_object', dataType: 'integer', dataLength: null, dataPrecision: null, dataScale: 0, nullable: 'YES'},
  })
  idObject?: number;
