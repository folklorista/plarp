...
@model({
  settings: {idInjection: false, postgresql: {schema: 'organizing', table: 'event_x_task'}}
})
export class EventXTask extends Entity {
  @property({
    type: 'number',
    required: true,
    scale: 0,
  ...
  constructor(data?: Partial<EventXTask>) {
    super(data);
  }
}

export interface EventXTaskRelations {
  // describe navigational properties here
}

export type EventXTaskWithRelations = EventXTask & EventXTaskRelations;
